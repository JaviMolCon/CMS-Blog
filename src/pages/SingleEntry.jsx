  ...
  return singleBlogPost?.fields?(
   ...
   <Header />
    <div className='flex flex-col items-center justify-center my-12'>
      ...
      <p className="flex text-xl mb-4"><p className='font-bold'>Post by:</p>{singleBlogPost.fields.author}</p>
      <img className='w-[800px] h-[500px] aspect-square object-cover px-2 rounded-3xl' src={singleBlogPost.fields.imgSrc} alt={singleBlogPost.fields.title} />
      ...
      <p className='flex justify-center items-center leading-loose text-lg'>{singleBlogPost.fields.content}</p>
      </div>
