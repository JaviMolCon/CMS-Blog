...
const Footer = () => {
  return (
    <div className='flex flex-col bg-primary py-8 px-2'>
      <div className='flex justify-evenly items-center flex-wrap gap-2'>
        <div className='flex gap-2'>
        <input type="email" placeholder="Enter your email" className="input input-bordered input-md w-full max-w-xs" />
        <button className="btn btn-active btn-ghost text-lg">Subscribe</button>
        </div>
