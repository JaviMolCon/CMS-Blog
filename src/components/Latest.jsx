...
export const Latest = () => {
  ...
  return (
    <>
    <div className='flex justify-center items-center text-4xl font-extrabold my-12'><h1>Latest Posts</h1></div>
    <div className='flex justify-center gap-4 md:gap-18 lg:gap-20 items-center flex-wrap mx-12 md:mx-48 lg:mx-12 xl:mx-64 my-12'>
      ...
      <div className="card w-[350px] h-[400px] bg-base-100 shadow-xl">
        <figure><img className='w-[350px] aspect-square object-cover' src={post.fields.imgSrc} alt={post.fields.title} /></figure>
